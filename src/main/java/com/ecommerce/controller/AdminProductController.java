...
public class AdminProductController {
	...
	@PostMapping("/creates/books")
	public ResponseEntity<ApiResponse> createMultipleBook(@RequestBody CreateBookRequest[] reqs) throws ProductException{

		for(CreateBookRequest product:reqs) {
